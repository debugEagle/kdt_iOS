...
/*!
 ...
 @constant kIOHIDEventTypeMouse             //16
...
enum {
    ...
    kIOHIDEventTypeKeyboard,                //3,硬件按键
    ...
    kIOHIDEventTypeDigitizer,               //11,屏幕
    kIOHIDEventTypeAmbientLightSensor,
    kIOHIDEventTypeAccelerometer,
    kIOHIDEventTypeProximity,               //14,接近传感器（贴脸）
...
enum {
    ...
    kIOHIDEventFieldDigitizerEventMask,             //7
    ...
    kIOHIDEventFieldDigitizerChildEventMask,         //24
    kIOHIDEventFieldDigitizerDisplayIntegrated
};
